...
2. Apply the review method, checklist, and report format defined in the `lore:documentation-reviewer` skill (bundled in the Lore plugin). That skill is the single source of truth for *how* to review; follow it exactly.
